...
public class AppointmentController {
    ...
    public List<AppointmentResponse> getMyAppointments(Authentication authentication) {
        ...
        List<Appointment> list = service.getAppointmentsByUser(user.getId());

        System.out.println("APPOINTMENTS SIZE: " + list.size());

        return list.stream().map(a -> new AppointmentResponse(
                a.getId(),
